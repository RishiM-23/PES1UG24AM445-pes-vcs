...
int object_write(ObjectType type, const void *data, size_t len, ObjectID *id_out) {
    ...
    // 3. Compute hash (USE PROVIDED FUNCTION)
    ...
    dir[strlen(dir) - (HASH_HEX_SIZE - 2)] = '\0'; // keep .pes/objects/XX
    mkdir(dir, 0755);
...
//   - memchr             : safely finding the '\0' separating header and dat//   - strncmp            : parsing the type string ("blob", "tree", "commit")
